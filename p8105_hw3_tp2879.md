...
Based on the plot it is clear that women across all education categories
have higher total activity compared to men until age 50. This trend
continues for those in the ‘High school equivalent’ and ‘More than high
school’ categories, however, males have more total activity than females
after age 50 in the ‘Less than high school’ category. In the ‘high
school equivalent’ category, there is a sharp jump in female total
activity around age 30 and begins to decrease and level to that of males
around age 50. In the ‘More than high school’ category, it seems that
male activity drops around age 60 compared to females.
...
Based on this graph, one can conclude that since minute 0 corresponds to
midnight or 12AM that is is when people are going to sleep and winding
down from the day. This explains the gradual decline in activity
patterns until about a third into the progression. By then it is the
time when people are waking up and getting ready for the day. This is
where the progression is seen to be increasing and slowly keeping
steadty until the last few hours of the day. Females, especially those
in the ‘More than high school’ education category, tend to have more
total activity throughout the day compared to males.
...
There are 4 data sets including data for Citi Bike from January 2020,
January 2024, July 2020 and July 2024. The variables within each data
set are very similar and were therefore merged into the citibike data
frame.
...
According to the table, there were far more members using Citi Bike
across each month observed compared to casual riders. In addition, it it
seems that both casual riding and member riding increased from January
2020 to July 2024.
...
It is clear, according to the plot, that July 2020 had the highest
ridership median compared to January 2024 which had the lowest. This may
be due to the pandemic and summer weather in which many people prefered
to be outdoors. Ridership was generally higher in July 2020 and July
2024 compared to January 2020 and January 2024, which can be
attributable to the summer weather. In addition, Saturday and Sunday
have the most ridership compared to other days of the week, except in
January 2024, the most ridership was on Friday and Saturday.
...
Based on the plot, it is clear that members using a classic bike have a
longer ride duration compared to members using electric bikes, which is
prevalent in January 2024, but dramatically increases in July 2024. For
casual riders, there are slightly longer durations while using a classic
bike than a Citi Bike during July 2024, however, casual members used
classic bike and electric bikes and nearly the same rate in January
2024.
